...
export class MigrationAdd1692775524625 implements MigrationInterface {
    name = 'MigrationAdd1692775524625'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_a6ac5c99b8c02bd4ee53d3785be\` ON \`order_detail\``);
        await queryRunner.query(`DROP INDEX \`FK_f626a585c81471495373d1a68fd\` ON \`order_detail\``);
        await queryRunner.query(`DROP INDEX \`FK_5c1cf55c308037b5aca1038a131\` ON \`post\``);
        await queryRunner.query(`DROP INDEX \`FK_3f62b42ed23958b120c235f74df\` ON \`customer\``);
        await queryRunner.query(`DROP INDEX \`FK_124456e637cca7a415897dce659\` ON \`order\``);
        await queryRunner.query(`DROP INDEX \`FK_15d817ff19ae88ce95bb0bb2ce5\` ON \`order\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`FK_15d817ff19ae88ce95bb0bb2ce5\` ON \`order\` (\`usersId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_124456e637cca7a415897dce659\` ON \`order\` (\`customerId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_3f62b42ed23958b120c235f74df\` ON \`customer\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_5c1cf55c308037b5aca1038a131\` ON \`post\` (\`userId\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_f626a585c81471495373d1a68fd\` ON \`order_detail\` (\`post_id\`)`);
        await queryRunner.query(`CREATE INDEX \`FK_a6ac5c99b8c02bd4ee53d3785be\` ON \`order_detail\` (\`order_id\`)`);
    }
